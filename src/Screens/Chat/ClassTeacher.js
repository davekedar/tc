            ...
            let { data } = await axios
              ...
              .then(response => {
                ...
                if (response.data.status === "success") {
                  //console.log("Success")
                  this.setState({
                    classTeacher: response.data.data.class_communication,
                  });
                } else {
              ...
              <FlatList
                ...
                renderItem={({ item }) => (
                  <ListItem
                    ...
                    onPress={()=>this.props.navigation.navigate('ClassTeacherSingle', {
                    class_id: item.class_section_name,
                    userid: this.state.userid,
                    usertype: this.state.usertype,
                    student_list: this.state.classTeacher
                    })}
                  />
                )}
