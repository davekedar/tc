...
import { List, ListItem, SearchBar } from "react-native-elements";
    ...
    class DepartmentIndividualSection extends Component{
        ...
        componentWillMount = async () => {
            const {class_id, section_id, school_id, employee_id} = this.props.navigation.state.params;
            await this.setState({
                school_id,
                section_id,
                class_id,
            ...
            console.log(this.state.employee_id, this.state.message, this.state.school_id, this.state.class_id, this.state.section_id)
        }
            ...
            try {
              let { data } = await axios
                .post("https://tgesconnect.org/api/General_communication_send_chat", {
                    ...
                    class_section_id: this.state.section_id
                })
                .then(response => {
...
export default DepartmentIndividualSection;
